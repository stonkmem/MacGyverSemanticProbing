...
if len(sys.argv) > 1:
  ...
  elif sys.argv[1] == 'llama' or sys.argv[1] == 'llama_70b' or sys.argv[1] == 'llama3.2' or sys.argv[1] == 'llama30' or sys.argv[1] == 'llama2' or sys.argv[1] == 'llama3.3' or sys.argv[1] == 'llama3-70b':
    from Llama_run_benchmark import *
